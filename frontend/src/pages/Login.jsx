...
//       <Card sx={{width: "100%",maxWidth: 420,borderRadius: "20px",boxShadow: "0 8px 24px rgba(0,0,0,0.15)",overflow: "hidden",background: "linear-gradient(180deg, #ffffff 0%, #f9fff9 100%)",}}>
//         <CardContent sx={{ p: 5 }}>
//           <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
//             <Avatar sx={{bgcolor: "#606060ff",mb: 2,width: 56,height: 56,boxShadow: "0 4px 12px rgba(119, 119, 119, 0.3)",}}>
//               <LockOpenIcon fontSize="medium" />
//             </Avatar>

//             <Typography variant="h5"sx={{mb: 1,fontWeight: 700,color: "#333",letterSpacing: 0.5,}}>Login Your Account  </Typography>
          
//             <Box component="form"onSubmit={handleSubmit}sx={{ width: "100%" }}>
//               <TextField label="Username"name="username"  value={form.username}  onChange={handleChange}  fullWidth  margin="normal"  required             sx={{
//                   "& .MuiOutlinedInput-root": {
//                     "& fieldset": { borderColor: "#ccc" },
//                     "&:hover fieldset": { borderColor: "#818181ff" },
//                     "&.Mui-focused fieldset": { borderColor: "#989898ff" },
//                   },
//                 }}
//               />

//               <TextField label="Password"name="password"type="password"value={form.password}onChange={handleChange}fullWidthmargin="normal"required
//                 sx={{
//                   "& .MuiOutlinedInput-root": {
//                     "& fieldset": { borderColor: "#ccc" },
//                     "&:hover fieldset": { borderColor: "#6a6a6aff" },
//                     "&.Mui-focused fieldset": { borderColor: "#5c5c5cff" },
//                   },
//                 }}
//               />
...
//               <Button type="submit"
//               variant="contained"
//               fullWidthsx={{mt: 3,py: 1.3,fontWeight: 600,
//                   fontSize: "1rem",
//                   textTransform: "none",
...
//               >
//                 Demo Login: <strong>user@example.com</strong> / <strong>012345</strong>
//               </Typography>
//             </Box>
//           </Box>
//         </CardContent>
